    ...
    <div id="experience" className="border-b border-neutral-900 pb-4">
      ...
      <div className="p-5 text-white">
        {experience.map((experience, index) => (
          <motion.div key={index} whileInView={{ opacity: 1, x: 50 }} initial={index % 2 === 0 ? { opacity: 0, x: 100 } : { opacity: 0, y: 0 }}
          transition={{ duration: 0.5 }}>
            <VerticalTimeline>
              <VerticalTimelineElement
                ...
                icon={<FontAwesomeIcon icon={index % 2 === 0 ? faUserGraduate : faLaptopCode} />}
